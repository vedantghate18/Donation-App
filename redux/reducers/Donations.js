...
const initialState = {
  ...
  selectedDonationsId: null,
  selectedDonationsInformation: {},
};

const Donations = createSlice({
  name: 'donations',
  initialState,
  selectedDonationsInformation: null,
  allDonations: [],
  reducers: {
    resetDonations: () => {
      return initialState;
    ...
    updateSelectedDonationsId: (state, action) => {
      state.selectedDonationsId = action.payload;
      state.selectedDonationsInformation = state.items.find(
...
export const { resetDonations, updateSelectedDonationsId } = Donations.actions;
